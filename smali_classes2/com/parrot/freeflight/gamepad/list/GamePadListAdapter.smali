...
.method private addToGamePadList(Ljava/util/List;Z)V
    .locals 3
    .param p1    # Ljava/util/List;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    .param p2, "filterConnected"    # Z
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List",
...
.method public update(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/parrot/freeflight/gamepad/list/GamePadListAdapter;->addToGamePadList(Ljava/util/List;Z)V

    .line 86
    const/4 v0, 0x0

    invoke-direct {p0, p2, v0}, Lcom/parrot/freeflight/gamepad/list/GamePadListAdapter;->addToGamePadList(Ljava/util/List;Z)V
