...
.method private findConnection(IIIZ)Lokhttp3/internal/connection/RealConnection;
    ...
    .line 162
    .local v8, "foundPooledConnection":Z
    const/4 v1, 0x0
    ...
    .line 166
    .local v15, "selectedRoute":Lokhttp3/Route;
    ...
    iget-object v11, v0, Lokhttp3/internal/connection/StreamAllocation;->connection:Lokhttp3/internal/connection/RealConnection;

    .line 174
    .local v11, "releasedConnection":Lokhttp3/Connection;
    invoke-direct/range {p0 .. p0}, Lokhttp3/internal/connection/StreamAllocation;->releaseIfNoNewStreams()Ljava/net/Socket;

    move-result-object v18

    .line 175
    .local v18, "toClose":Ljava/net/Socket;
    move-object/from16 v0, p0
    ...
    iget-boolean v2, v0, Lokhttp3/internal/connection/StreamAllocation;->reportedAcquired:Z
    ...
    iget-object v5, v0, Lokhttp3/internal/connection/StreamAllocation;->address:Lokhttp3/Address;

    const/4 v6, 0x0

    move-object/from16 v0, p0

    invoke-virtual {v2, v4, v5, v0, v6}, Lokhttp3/internal/Internal;->get(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/Route;)Lokhttp3/internal/connection/RealConnection;
    ...
    .line 196
    invoke-static/range {v18 .. v18}, Lokhttp3/internal/Util;->closeQuietly(Ljava/net/Socket;)V
    ...
    invoke-virtual {v2, v3, v11}, Lokhttp3/EventListener;->connectionReleased(Lokhttp3/Call;Lokhttp3/Connection;)V
    ...
    invoke-virtual {v2, v3, v1}, Lokhttp3/EventListener;->connectionAcquired(Lokhttp3/Call;Lokhttp3/Connection;)V
    ...
    .local v12, "result":Lokhttp3/internal/connection/RealConnection;
    :goto_1
    return-object v12

    .line 192
    .end local v12    # "result":Lokhttp3/internal/connection/RealConnection;
    .restart local v1    # "result":Lokhttp3/internal/connection/RealConnection;
    :cond_8
    :try_start_2
    move-object/from16 v0, p0

    iget-object v15, v0, Lokhttp3/internal/connection/StreamAllocation;->route:Lokhttp3/Route;
    :try_end_2
    ...
    .line 223
    .local v14, "routes":Ljava/util/List;, "Ljava/util/List<Lokhttp3/Route;>;"
    const/4 v9, 0x0
    ...
    .line 225
    .local v13, "route":Lokhttp3/Route;
    sget-object v2, Lokhttp3/internal/Internal;->instance:Lokhttp3/internal/Internal;
    ...
    invoke-virtual {v2, v4, v5, v0, v13}, Lokhttp3/internal/Internal;->get(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/Route;)Lokhttp3/internal/connection/RealConnection;
    ...
    iput-object v13, v0, Lokhttp3/internal/connection/StreamAllocation;->route:Lokhttp3/Route;
    :try_end_4
    ...
    .end local v1    # "result":Lokhttp3/internal/connection/RealConnection;
    .end local v9    # "i":I
    .end local v13    # "route":Lokhttp3/Route;
    .end local v14    # "routes":Ljava/util/List;, "Ljava/util/List<Lokhttp3/Route;>;"
    .end local v16    # "size":I
    .restart local v12    # "result":Lokhttp3/internal/connection/RealConnection;
    :goto_4
    if-nez v8, :cond_11
    ...
    iput v2, v0, Lokhttp3/internal/connection/StreamAllocation;->refusedStreamCount:I
    ...
    invoke-direct {v1, v2, v15}, Lokhttp3/internal/connection/RealConnection;-><init>(Lokhttp3/ConnectionPool;Lokhttp3/Route;)V
    :try_end_5
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/connection/StreamAllocation;->acquire(Lokhttp3/internal/connection/RealConnection;Z)V
    ...
    .restart local v13    # "route":Lokhttp3/Route;
    .restart local v14    # "routes":Ljava/util/List;, "Ljava/util/List<Lokhttp3/Route;>;"
    ...
    iget-object v6, v0, Lokhttp3/internal/connection/StreamAllocation;->call:Lokhttp3/Call;

    move-object/from16 v0, p0

    iget-object v7, v0, Lokhttp3/internal/connection/StreamAllocation;->eventListener:Lokhttp3/EventListener;
    ...
    invoke-virtual/range {v1 .. v7}, Lokhttp3/internal/connection/RealConnection;->connect(IIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-boolean v2, v0, Lokhttp3/internal/connection/StreamAllocation;->reportedAcquired:Z
    ...
    invoke-virtual {v2, v4, v1}, Lokhttp3/internal/Internal;->put(Lokhttp3/ConnectionPool;Lokhttp3/internal/connection/RealConnection;)V
    ...
    invoke-virtual {v2, v4, v5, v0}, Lokhttp3/internal/Internal;->deduplicate(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/internal/connection/StreamAllocation;)Ljava/net/Socket;
    ...
    .line 274
    invoke-static/range {v17 .. v17}, Lokhttp3/internal/Util;->closeQuietly(Ljava/net/Socket;)V
