...
.method private getBLEProductHasMinicam([B)Z
    .locals 10
    .param p1, "scanRecord"    # [B
    ...
    .line 540
    .end local v1    # "adType":I
    .end local v3    # "has_camera":I
    :cond_0
    :goto_0
    return v5

    .restart local v1    # "adType":I
    .restart local v3    # "has_camera":I
    :cond_1
    move v5, v7
...
.method public bleCallback(Landroid/bluetooth/BluetoothDevice;I[B)V
    ...
    .line 388
    invoke-direct {p0, p3}, Lcom/parrot/arsdk/ardiscovery/ARDiscoveryBLEDiscoveryImpl$BLEScanner;->getBLEProductHasMinicam([B)Z

    move-result v3

    invoke-virtual {v0, v3}, Lcom/parrot/arsdk/ardiscovery/ARDiscoveryDeviceBLEService;->setHasMinicam(Z)V
